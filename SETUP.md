...
DATABASE_URL="postgresql://username:password@ep-xxx-pooler.<리전>.neon.tech/neondb?sslmode=require"
DIRECT_URL="postgresql://username:password@ep-xxx.<리전>.neon.tech/neondb?sslmode=require"
```
...
>
> Neon 은 일정 시간 비활성 시 슬립 → 첫 요청이 1~2초 더 걸릴 수 있습니다. 학교 규모에서는 보통 허용 범위입니다.
